...
script.createCommand(
    Commands.slashCommand("v3-starboard-channel", "set the starboard channel")
...
script.createCommand(
    Commands.slashCommand("v3-starboard-threshold", "set how many stars are needed")
...
script.createCommand(
    Commands.slashCommand("v3-star-stats", "show top star givers and receivers")
        .build(async (ctx) => {
...
script.createCommand(
    Commands.messageCommand("v3 Star Info")
