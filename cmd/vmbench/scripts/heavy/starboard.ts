...
script.createCommand(
    Commands.slashCommand("starboard-channel", "set the starboard channel")
...
script.createCommand(
    Commands.slashCommand("starboard-threshold", "set how many stars are needed")
...
script.createCommand(
    Commands.slashCommand("star-stats", "show top star givers and receivers")
        .build(async (ctx) => {
...
script.createCommand(
    Commands.messageCommand("Star Info")
