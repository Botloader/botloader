...
use common::{
    plugin::{
        Image, Plugin, PluginData, PluginImage, PluginImageKind, PluginType, ScriptPluginData,
    },
    user::UserMeta,
};
...
impl Db {
    ...
    pub async fn get_guild_script_count(
    ...
    pub async fn get_guild_scripts(
        conn: &mut PgConnection,
        guild_id: Id<GuildMarker>,
...
impl Db {
    ...
    pub async fn list_scripts(&self, guild_id: Id<GuildMarker>) -> ConfigStoreResult<Vec<Script>> {
    ...
    pub async fn get_guild_meta_config_or_default(
        &self,
        guild_id: Id<GuildMarker>,
    ...
    pub async fn add_update_joined_guild(
        &self,
        guild: JoinedGuild,
    ...
    pub async fn set_guild_left_status(
        &self,
        guild_id: Id<GuildMarker>,
        left: bool,
    ) -> ConfigStoreResult<JoinedGuild> {
    ...
    pub async fn get_joined_guilds(
        &self,
        ids: &[Id<GuildMarker>],
    ...
    pub async fn get_joined_guilds_not_in(
        &self,
        ids: &[Id<GuildMarker>],
    ) -> ConfigStoreResult<Vec<JoinedGuild>> {
        let guilds = sqlx::query_as!(
    ...
    pub async fn delete_guild_config_data(&self, id: Id<GuildMarker>) -> ConfigStoreResult<()> {
    ...
    pub async fn get_user_premium_slots(
        &self,
    ...
    pub async fn create_update_premium_slot_by_source(
        &self,
...
RETURNING id, title, user_id, message, source, source_id, tier, state, created_at, 
    ...
    pub async fn update_premium_slot_attachment(
        &self,
        user_id: Id<UserMarker>,
        slot_id: u64,
...
RETURNING id, title, user_id, message, source, source_id, tier, state, created_at, 
    ...
    pub async fn create_plugin(&self, create_plugin: CreatePlugin) -> ConfigStoreResult<Plugin> {
        let res = sqlx::query_as!(
            DbPlugin,
...
installed_guilds_updated_at"#,
    ...
    pub async fn update_script_plugin_dev_version(
        &self,
        plugin_id: u64,
        new_source: String,
    ) -> ConfigStoreResult<Plugin> {
...
"#,
    ...
    pub async fn publish_script_plugin_version(
        &self,
        plugin_id: u64,
        new_source: String,
...
"#,
    ...
    pub async fn get_user_meta(&self, user_id: u64) -> ConfigStoreResult<Option<UserMeta>> {
        let res = sqlx::query_as!(
            DbUserMeta,
    ...
    pub async fn get_plugin(&self, plugin_id: u64) -> ConfigStoreResult<Plugin> {
        Self::inner_get_plugin(&mut *self.pool.acquire().await?, plugin_id).await
    }

    pub async fn get_plugins(&self, plugin_ids: &[u64]) -> ConfigStoreResult<Vec<Plugin>> {
...
ORDER BY id ASC"#,
    ...
    pub async fn get_user_plugins(&self, user_id: u64) -> ConfigStoreResult<Vec<Plugin>> {
        let raw_plugins = sqlx::query_as!(
            DbPlugin,
            r#"SELECT id,
created_at,
...
ORDER BY id ASC"#,
    ...
    pub async fn get_published_public_plugins(&self) -> ConfigStoreResult<Vec<Plugin>> {
        let raw_plugins = sqlx::query_as!(
            DbPlugin,
            r#"SELECT id,
created_at,
...
ORDER BY id ASC"#,
    ...
    pub async fn try_guild_add_script_plugin(
        &self,
        guild_id: Id<GuildMarker>,
        plugin_id: u64,
        auto_update: bool,
    ...
    pub async fn create_image(&self, create: CreateImage) -> ConfigStoreResult<Uuid> {
        let res = sqlx::query!(
    ...
    pub async fn soft_delete_image(&self, _id: Uuid) -> ConfigStoreResult<Uuid> {
        todo!()
    }
}
